...
| 1:00 – 1:30 | What I built | **"MPP.sol fills it. Five repos at github.com/mppsol — frozen spec, three TypeScript SDKs on npm, twelve on-chain instructions across two Anchor programs on Solana devnet. A hundred and twenty tests passing — TypeScript and Anchor combined. Real on-chain payment captured in the demo. And one thing no other MPP adapter has: a CPI primitive with atomic on-chain payment-binding — structurally impossible on EVM."** |
...
| 1:48 – 2:00 | Ask + close | **"Direct mode mainnet-shippable today. Twelve on-chain instructions live on devnet — including atomic on-chain payment-binding via Receipt PDAs, shipped during the hackathon. Looking for accelerator support for mainnet and audit. mppsol-dot-org. Thank you."** |
