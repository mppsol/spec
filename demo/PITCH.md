...
| 1:00 – 1:30 | What I built | **"MPP.sol fills it. Five repos at github.com/mppsol — frozen spec, three TypeScript SDKs on npm, twelve on-chain instructions across two Anchor programs on Solana devnet. A hundred and nine tests passing — TypeScript and Anchor combined. Real on-chain payment captured in the demo. And one thing no other MPP adapter has: a CPI primitive with atomic on-chain payment-binding — structurally impossible on EVM."** |
